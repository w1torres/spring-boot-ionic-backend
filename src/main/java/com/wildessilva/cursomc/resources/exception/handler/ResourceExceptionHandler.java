package com.wildessilva.cursomc.resources.exception.handler;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFoundResponseEntity(ObjectNotFoundException e, HttpServletRequest request){
    ...
    public ResponseEntity<StandardError> file(ObjectNotFoundException e, HttpServletRequest request){
