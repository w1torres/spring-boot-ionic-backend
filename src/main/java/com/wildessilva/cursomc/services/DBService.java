...
public class DBService {
	...
	Cliente cli1 = new Cliente(null, "Maria Silva", "wildestorres@gmail.com","36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
	cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

	Cliente cli2 = new Cliente(null, "Ana Costa", "wildes.silva@gmail.com","71853402338", TipoCliente.PESSOAFISICA, pe.encode("123"));
    cli2.getTelefones().addAll(Arrays.asList("93888321", "3425262525"));
